...
/*
  ...
  DDL, but that would be counterproductive, as one of the main points of stormweaver
  ...
  holes in the data, that means data can be effectively anywhere, and stormweaver
  ...
  the hole created in DROP, stormweaver can have an issue of "losing" the table
  ...
  5. For CREATE TABLE, stormweaver has to reserve a slot BEFORE creating the table,
